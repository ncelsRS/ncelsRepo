    ...
    public class ContractController : ACommonController
    {
        ...
        public ActionResult GetAllList(ModelRequest request)
        {
            var result = _contractRepository.EmployeeContracts(UserHelper.GetCurrentEmployee().Id).ToDataSourceResult(request, e => new
            {
                ...
                StatusCode = e.ContractStatus.Code
            });
        ...
        public ActionResult LoadContract(Guid id)
        {
            ...
            if (project == null)
            {
                ...
                project = new Contract()
                {
                    ...
                    AgentOrganizationId = Guid.NewGuid(),
                    Type = 1,
                    CreatedDate = DateTime.Now,
                ...
                agent = new Organization() { Id = project.AgentOrganizationId.Value, Type = 25, DocDate = DateTime.Now, DocExpiryDate = DateTime.Now };
            ...
            else
            {
                ...
                if (project.AgentOrganizationId == null)
                {
                    project.AgentOrganizationId = Guid.NewGuid();
                    agent = new Organization() { Id = project.AgentOrganizationId.Value, Type = 25, DocDate = DateTime.Now, DocExpiryDate = DateTime.Now };
                }
                else
                {
                    agent = db.Organizations.FirstOrDefault(o => o.Id == project.AgentOrganizationId);
                }
            ...
            return Content(JsonConvert.SerializeObject(new RequestModel
            {
                ...
                NewManufactureId = Guid.NewGuid(),
                NewApplicantId = Guid.NewGuid(),
                NewHolderId = Guid.NewGuid(),
                NewPayerId = Guid.NewGuid(),
                NewPayerTranslationId = Guid.NewGuid(),
                NewAgentId = Guid.NewGuid(),
        ...
        public ActionResult Delete(Guid id, string returnAction)
        {
