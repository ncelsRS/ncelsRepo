function setIsNotApplicabled(control) {
    var documentId = $(control).closest("attach-edit").attr('path');
    ...
    var params = JSON.stringify({ 'documentId': documentId, 'categoryId': categoryId, 'isChecked': isChecked });

    $.ajax({
        type: "POST",
        url: '/Upload/SetIsNotApplicabled',
        data: params,
        dataType: 'json',
        cache: false,
