...
function InitContractCard(uiId) {
    ...
    var viewModel = kendo.observable({
        ...
        sendToHeadAgreement: function (e) {
            ...
            window.data("kendoWindow").refresh('/Contract/SetContractNumber?contractId=' + $('#contractId' + uiId).val());
            window.data("kendoWindow").title('Номер и дата договора');
            window.data("kendoWindow").setOptions({
                width: "650",
                height: "auto"
            });
        ...
        changeNumberAndDate: function(e) {
            var window = $("#TaskCommandWindow");
            window.kendoWindow({
                width: "650",
                height: "auto",
        ...
        approve: function (e) {
            ...
            $("#TaskCommandWindow").data("kendoWindow").dialogCallback = function () {
                alert('Договор согласован и отправлен на подписание');
                $('#approveContract' + uiId).addClass('k-state-disabled');
                $('#rejectContract' + uiId).addClass('k-state-disabled');
            };
        ...
        reject: function (e) {
            ...
            $("#TaskCommandWindow").data("kendoWindow").dialogCallback = function () {
                alert('Договор отправлен на доработку юристконсульту');
                $('#approveContract' + uiId).addClass('k-state-disabled');
                $('#rejectContract' + uiId).addClass('k-state-disabled');
            };
            window.data("kendoWindow").refresh('/Contract/Reject?contractId=' + $('#contractId' + uiId).val());
