...
function InitializeSizeAdministrative(name) {
    var gridElement = $("#pwContentRightId" + name);
    gridElement.height($(window).height() - 120);
}

function InitializeDataAdministrative(name, repeatId) {
    ...
    function loadDocument() {
        ...
        $.ajax({
            type: 'get',
            url: '/AdministrativeDoc/DocumentRead?Id=' + name + '&repeatId=' + repeatId,
            ...
            success: function (result) {
                ...
                InitializePropertyAdministrative(name, viewModel);
    ...
    function excludeData() {
        ...
        window.data("kendoWindow").refresh('/AdministrativeDoc/Execution?id=' + viewModel.get("document.Id"));
    ...
    function registerData() {
        ...
        $.ajax({
            type: 'POST',
            url: '/AdministrativeDoc/DocumentRegister',
            data: json,
            contentType: 'application/json; charset=utf-8',
            success: function (result) {
                result = JSON.parse(result);
    ...
    function extensionExecution() {
        ...
        window.data("kendoWindow").refresh('/AdministrativeDoc/ExtensionExecution?id=' + viewModel.get("document.Id"));
    ...
    function reviewData() {
        ...
        $.ajax({
            type: 'POST',
            url: '/AdministrativeDoc/DocumentReview',
            data: json,
            contentType: 'application/json; charset=utf-8',
            success: function (result) {
                result = JSON.parse(result);
    ...
    function sendData() {
        ...
        $.ajax({
            type: 'POST',
            url: '/AdministrativeDoc/DocumentUpdate',
            data: json,
            contentType: 'application/json; charset=utf-8',
            success: function (result) {
                if (result == 'True') {
...
function InitializePropertyAdministrative(name, viewModel) {
    ...
    $("#ReadersId" + name).kendoMultiSelect({
        ...
        dataSource: {
            transport: {
                read: {
                    url: '/Reference/AllListEmployeForAdministrativeDocument'
   ...
   // $("#Counters" + name).kendoMaskedTextBox({ mask: "листов: 0, приложений: 0, копий: 0" });
