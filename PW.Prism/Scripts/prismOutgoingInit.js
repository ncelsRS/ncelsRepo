...
function InitializeSizeOutgoingInit(name) {
    var gridElement = $("#pwContentRightId" + name);
    gridElement.height($(window).height() - 120);
}

function InitializeDataOutgoingInit(name) {
    ...
    function loadDocument() {
        ...
        $.ajax({
            type: 'get',
            url: '/OutgoingDoc/DocumentReadInit?Id=' + name,
            ...
            success: function (result) {
                ...
                InitializePropertyOutgoingInit(name, viewModel);
...
function InitializePropertyOutgoingInit(name, viewModel) {
