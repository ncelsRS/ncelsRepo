...
{
	[Authorize]
    public class AdministrativeMainDocController : Controller
    {
		...
		public ActionResult Index() {
			...
			ViewBag.AdministrativeMain = db.Dictionaries.Where(o => o.Type == "AdministrativeMainTypeDictionary").ToList().Select(o => new Item() { Id = o.Id.ToString(), Name = LocalizationHelper.GetString(o.Name, o.NameKz) }).ToList();
		...
		public ActionResult ListDocument([DataSourceRequest] DataSourceRequest request) {
			var docs = db.Documents.Where(o => o.IsDeleted == false && o.DocumentType == 3 && o.ProjectType == 6);
