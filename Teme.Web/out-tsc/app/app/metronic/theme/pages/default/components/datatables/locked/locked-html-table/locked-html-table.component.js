...
var LockedHtmlTableComponent = (function () {
    ...
    LockedHtmlTableComponent.prototype.ngAfterViewInit = function () {
        this._script.loadScripts('app-locked-html-table', ['assets/demo/default/custom/components/datatables/locked/html-table.js']);
    };
    LockedHtmlTableComponent = __decorate([
        Component({
