...
@Component({
  selector: 'app-ext-cost-info',
  templateUrl: './ext-cost-info.component.html',
  styleUrls: ['./ext-cost-info.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ExtCostInfoComponent implements OnInit {
