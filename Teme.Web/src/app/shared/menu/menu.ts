...
export const verticalMenuItems = [
  new Menu(123, 'Не распределенные', '/int/spa/contracts', null, 'tachometer', null, false, 0),
  new Menu(22543, 'В работе', '', null, 'font-awesome', null, false, 0),
  new Menu(939, 'На карректировке', '/pages/dashboard', null, 'object-group', null, false, 0),
  new Menu(412, 'Требует согласования', '/pages/dashboard', null, 'font-awesome', null, false, 0),
  new Menu(512, 'Согласованные', '/pages/dashboard', null, 'font-awesome', null, false, 0),
  new Menu(126, 'Не согласованные', '/pages/dashboard', null, 'creative-commons', null, false, 0),
  new Menu(7123, 'Активные', '/pages/dashboard', null, 'font-awesome', null, false, 0),
  new Menu(812, 'Истекшие', '/pages/dashboard', null, 'th-list', null, false, 0),
  new Menu(1239, 'Все', '/pages/dashboard', null, 'object-group', null, false, 0),
]
