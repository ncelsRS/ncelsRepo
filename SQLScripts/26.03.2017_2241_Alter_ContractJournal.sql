...
SELECT        c.Id, c.ManufacturerOrganizationId, c.ApplicantOrganizationId, c.DoverennostTypeDicId, c.DoverennostNumber, c.DoverennostCreatedDate,
 c.DoverennostExpiryDate, c.HolderOrganizationId, c.PayerOrganizationId, (CASE WHEN c.Number IS NOT NULL THEN c.Number ELSE N'б/н' END) as Number, c.CreatedDate, c.ContractId, c.ContractDate,
 ...
 po.NameRu AS PayerName, doc.CorrespondentsId, doc.CorrespondentsValue, doc.ExecutorsId as ExecutorId,
                             (SELECT        COUNT(*) AS Expr1
                               ...
                               WHERE        (ContractId = c.Id)) AS CountApplications, c.SignerId
