create view [dbo].[EXP_DrugDeclarationRegisterView] as
...
c.Id as CountryId, c.Name as CountryRu, c.NameKz as CountryKz, aplo.Name as ApplicantName, d.StatusId, s.NameRu as StatusRu, s.NameKz as StatusKz, dt.DrugTypeRu, dt.DrugTypeKz,
...
inner join Employees apl on apl.Id=d.OwnerId
inner join Units aplo on aplo.Id=apl.OrganizationId
