...
/****** Object:  View [dbo].[EXP_DrugDeclarationRegisterView]    Script Date: 11.05.2017 11:11:40 ******/
SET ANSI_NULLS ON
GO
...
SELECT        
	...
	CONVERT(bit, 0) AS Paid, 
	CONVERT(datetime, NULL) PaymentDate/*convert(bit,iif(dp.Id is null,0,1)) as Paid, dp.PaymentDatetime1C as PaymentDate*/ , 
