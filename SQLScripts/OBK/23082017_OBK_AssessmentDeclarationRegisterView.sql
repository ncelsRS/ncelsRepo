...
/****** Object:  View [dbo].[OBK_AssessmentDeclarationRegisterView]    Script Date: 23.08.2017 11:27:37 ******/
...
FROM            dbo.OBK_AssessmentStage AS [as] INNER JOIN
                         ...
                         dbo.OBK_DeclarantContact AS dc ON c.DeclarantContactId = dc.Id ON ad.Contract_Id = c.Id INNER JOIN
                         dbo.OBK_Ref_Type AS rt ON ad.Type_Id = rt.Id INNER JOIN
