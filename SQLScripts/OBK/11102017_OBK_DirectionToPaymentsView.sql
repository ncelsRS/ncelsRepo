...
/****** Object:  View [dbo].[OBK_DirectionToPaymentsView]    Script Date: 11.10.2017 15:18:03 ******/
SET ANSI_NULLS ON
GO
...
SELECT        pay.CreateDate, pay.ContractId, pay.CreateEmployeeId, pay.CreateEmployeeValue, pay.PayerId, pay.PayerValue, pay.StatusId, pay.IsDeleted, emp.DisplayName, pay.TotalPrice, ref_status.Code AS StatusCode, 
                         pay.InvoiceNumber, contract.Number AS ContractNumber, contract.StartDate AS ContractStartDate
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[40] 4[38] 2[16] 3) )"
      End
