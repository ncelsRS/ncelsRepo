...
/****** Object:  View [dbo].[OBK_DirectionToPaymentsView]    Script Date: 02.11.2017 12:05:32 ******/
...
SELECT        pay.CreateDate, pay.ContractId, pay.CreateEmployeeId, pay.CreateEmployeeValue, pay.PayerId, pay.PayerValue, pay.StatusId, pay.IsDeleted, emp.DisplayName, pay.TotalPrice, ref_status.Code AS StatusCode, 
                         ...
                         THEN 'Нет' ELSE 'Да' END AS ExecutorSign, dsd.ChiefAccountantId, CASE WHEN dsd.ChiefAccountantSign IS NULL THEN 'Нет' ELSE 'Да' END AS ChiefAccountantSign, contract.ExpertOrganization, 
                         eChief.ShortName AS ChiefName, eEmploy.ShortName AS ExecutorName
