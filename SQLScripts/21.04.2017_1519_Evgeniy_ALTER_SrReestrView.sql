...
/****** Object:  View [dbo].[SrReestrView]    Script Date: 21.04.2017 15:12:06 ******/
SET ANSI_NULLS ON
GO
...
SELECT   
	...
	, sr_dr.id as degree_risk_id
	, sr_dr.name as degree_risk_name
FROM            
	...
	LEFT JOIN sr_degree_risks as sr_dr on sr_mt.degree_risk_id=sr_dr.id
WHERE        
