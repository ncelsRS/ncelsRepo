...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'% содержания активного вещества' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EXP_Materials', @level2type=N'COLUMN',@level2name=N'ActiveSubstancePercent'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'% содержание воды' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EXP_Materials', @level2type=N'COLUMN',@level2name=N'WaterContentPercent'
GO
