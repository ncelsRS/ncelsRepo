...
/****** Object:  View [dbo].[PriceProjectsView]    Script Date: 03/27/2017 13:55:41 ******/
SET ANSI_NULLS ON
GO
...
SELECT        pp.Id, pp.Type, pp.Number, pp.CreatedDate, pp.Status, pp.OwnerId, pp.ManufacturerOrganizationId, pp.HolderOrganizationId, pp.ProxyOrganizationId, pp.DoverennostNumber, pp.DoverennostCreatedDate, 
                         ...
                         d2.Name AS IntroducingMethodName, d3.Name AS ImnSecuryTypeName, d4.Name AS RePriceName, pp.PriceProjectId, pp.Volume
