...
AS
SELECT        pp.Id, pp.Type, (CASE WHEN doc.Number IS NOT NULL THEN doc.Number ELSE 'б/н' END) AS Number, (CASE WHEN doc.OutgoingNumber IS NOT NULL THEN doc.OutgoingNumber ELSE 'б/н' END) AS OutgoingNumber, pp.CreatedDate, pp.Status, pp.OwnerId, pp.ManufacturerOrganizationId, pp.HolderOrganizationId, 
