...
namespace PW.Ncels.Database.Helpers
{
	public class ReportHelper
	{
        ...
        public static List<DictionaryInfo> GetLimsEquipmentReportList()
        {
            XmlReader reader = XmlReader.Create(HttpContext.Current.Server.MapPath(@"..\Content\Xml\LimsEquipmentReportList.xml"));
            XDocument doc = XDocument.Load(reader);
            XElement xElement = doc.Element("Dictionaries");
            if (xElement == null)
                return new List<DictionaryInfo>();
