...
{
    public class EmployeePermissionHelper
    {
        ...
        public static void Init()
        {
            ...
            AddPermission("IsRefEmployeesDashboard", @"Модуль 'Дашборд'", "Просмотр данных для распределения по исполнителям", "Дашборд");
            ...
            AddPermission("IsMenuAvgExchangeRateVisibility", @"Модуль 'Ценообразование'", "Справочник: Средневзвешенный курс валют", "Доступ в главном меню Ценообразование");
            ...
            AddPermission("IsMenuRequestOrderAllRowsReportVisibility", @"Модуль 'Ценообразование'", "Вкладка 'Ценообразование' Отчет: Общий список", "Доступ в главном меню Ценообразование");
            AddPermission("IsMenuRequestOrderStatisticReportVisibility", @"Модуль 'Ценообразование'", "Вкладка 'Ценообразование' Отчет: Статистика", "Доступ в главном меню Ценообразование");
            AddPermission("IsStateRegisterUpdate", @"Модуль 'Ценообразование'", "Обновление гос. реестра", "Доступ в главном меню Ценообразование");
            ...
            AddPermission("CanChangeContractNumberAndDate", @"Модуль 'Договоры'", "Изменение даты и номера договора", "Доступ в главном меню Договоры");
            ...
            AddPermission("IsMenuExpertiseStage8Visibility", @"Модуль 'Экспертиза'", "Вкладка 'Направление на оплату'", "Доступ в главном меню Экспертиза");
            ...
            AddPermission("IsReestrDirectionToPay", @"Модуль 'Экспертиза'", "Вкладка 'Реестр направлений'", "Доступ в главном меню Экспертиза");
            AddPermission("IsReestrCertificateOfComplete", @"Модуль 'Экспертиза'", "Вкладка 'Реестр акта выполненных работ'", "Доступ в главном меню Экспертиза");

            // LIMS TMC
            #region Lims Permessions
            AddPermission("IsViewTmcList", @"Возможность просматривать список ТМЦ", "Возможность просматривать список ТМЦ", "ЛИМС. Разрешения на действия в подсистеме");
            AddPermission("IsFrpCenterTmc", @"Право на выдачу ТМЦ со склада ИЦ", "Право на выдачу ТМЦ со склада ИЦ", "ЛИМС. Разрешения на действия в подсистеме");
            AddPermission("IsFrpDepartmentTmc", @"Право на выдачу ТМЦ по подразделению", "Право на выдачу ТМЦ по подразделению", "ЛИМС. Разрешения на действия в подсистеме");
            #endregion
            ...
            // Копия ЗБК
            #region
            AddPermission("ZBKCopyViewRequest", @"Модуль 'Запрос на копии ЗБК' 'ОБК'", "Возможность видеть заявки на копии ЗБК на уровне ЦОЗ", "Работа с заявками копии ЗБК");
            AddPermission("ZBKCopyEditBlanks", @"Модуль 'Запрос на копии ЗБК' 'ОБК'", "Возможность добавлять и заменять бланки на уровне ОБК", "Работа с заявками копии ЗБК");
            #endregion
            ...
            #region Учет бланков
            AddPermission("BlankAccounting", @"Модуль 'Учет бланков' 'Учет бланков'", "Возможность видеть меню", "Работа с учетом бланков");
            AddPermission("UsedBlanks", @"Модуль 'Учет бланков' 'Учет бланков'", "Внесение сведений по использованным бланкам", "Работа с учетом бланков");
            AddPermission("UserCorruptsBlanks", @"Модуль 'Учет бланков' 'Учет бланков'", "Внесение сведений по испорченным бланкам", "Работа с учетом бланков");
            ...
            AddPermission("ZBKApplicationReport", @"Модуль 'Отчеты ОБиК' 'Отчеты ОБиК'", "Просмотр журнала приложении ЗБК", "Просмотр отчетов ОБиК");
            AddPermission("DirectionPaymentsReport", @"Модуль 'Отчеты ОБиК' 'Отчеты ОБиК'", "Просмотр журнала учета выписанных счетов", "Просмотр отчетов ОБиК");
            AddPermission("ZBKDetailReport", @"Модуль 'Отчеты ОБиК' 'Отчеты ОБиК'", "Просмотр отчета о выдаче заключений о безопасности и качестве", "Просмотр отчетов ОБиК");
            AddPermission("ZBKDefectiveProductReport", @"Модуль 'Отчеты ОБиК' 'Отчеты ОБиК'", "Просмотр отчета о выдаче забракованной продукции", "Просмотр отчетов ОБиК");
            AddPermission("GMPReport", @"Модуль 'Отчеты ОБиК' 'Отчеты ОБиК'", "Просмотр отчета GMP сертификатов", "Просмотр отчетов ОБиК");
            AddPermission("SummaryReportTF", @"Модуль 'Отчеты ОБиК' 'Отчеты ОБиК'", "Просмотр сводного отчета по ТФ", "Просмотр отчетов ОБиК");
            AddPermission("LaboratoryTestsReport", @"Модуль 'Отчеты ОБиК' 'Отчеты ОБиК'", "Просмотр отчета о лабораторных испытаниях ", "Просмотр отчетов ОБиК");
            #endregion
        ...
        /// <summary>
        /// Дашборд Распределение по исполнителям
        /// </summary>
        public static bool IsRefEmployeesDashboard { get { return IsVisibility("IsRefEmployeesDashboard"); } }
        ...
        /// <summary>
        /// Права МОЛ департамента
        /// </summary>
        public static bool IsFrpDepartmentTmc
        {
            get { return IsVisibility("IsFrpDepartmentTmc"); }
        }
        ...
        public static bool IsMenuAvgExchangeRateVisibility { get { return IsVisibility("IsMenuAvgExchangeRateVisibility"); } }
        public static bool IsMenuRequestOrderAllRowsReportVisibility { get { return IsVisibility("IsMenuRequestOrderAllRowsReportVisibility"); } }
        public static bool IsMenuRequestOrderStatisticReportVisibility { get { return IsVisibility("IsMenuRequestOrderStatisticReportVisibility"); } }
        ...
        public static bool IsReestrDirectionToPay{ get { return IsVisibility("IsReestrDirectionToPay"); } }
        public static bool IsReestrCertificateOfComplete { get { return IsVisibility("IsReestrCertificateOfComplete"); } }
        ...
        public static bool IsStateRegisterUpdate { get { return IsVisibility("IsStateRegisterUpdate"); } }
        public static bool CanChangeContractNumberAndDate
        {
            get
            {
                return IsVisibility("CanChangeContractNumberAndDate");
            }
        }
        ...
        {
            public static string IsFrpCenterTmc => "IsFrpCenterTmc";
            public static string IsFrpDepartmentTmc => "IsFrpDepartmentTmc";
        }
