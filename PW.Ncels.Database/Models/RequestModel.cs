...
namespace PW.Ncels.Database.Models
{
    public class RequestModel
    {
        ...
        public Organization Agent { get; set; }
        ...
        public Guid NewManufactureId { get; set; }
        public Guid NewApplicantId { get; set; }
        public Guid NewHolderId { get; set; }
        public Guid NewPayerId { get; set; }
        public Guid NewPayerTranslationId { get; set; }
