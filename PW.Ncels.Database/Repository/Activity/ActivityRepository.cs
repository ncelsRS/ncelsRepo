...
namespace PW.Ncels.Database.Repository.Activity
{
    public class ActivityRepository: ARepositoryGeneric<EXP_Activities>
    {
        ...
        public IQueryable<EXP_AgreementProcSettingsActivities> GetSettingActivities(Expression<Func<EXP_AgreementProcSettingsActivities, bool>> filter = null)
        {
            if (filter == null)
                return AppContext.EXP_AgreementProcSettingsActivities;
            return AppContext.EXP_AgreementProcSettingsActivities.Where(filter);
        }
