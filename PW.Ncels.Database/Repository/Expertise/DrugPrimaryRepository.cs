            ...
            try {
                ...
                if (list.Count > 0) {
                    ...
                    foreach (var expertiseStage in list) {
                        ...
                        var executors = expertiseStage.EXP_ExpertiseStageExecutors.ToList();
                        foreach (var executor in executors) {
                            notificationManager.SendNotificationAnonymous(messageText, ObjectType.Letter, expertiseStage.EXP_DrugDeclaration.Id.ToString(), executor.ExecutorId);
                        }
