    ...
    public class SafetyreportRepository : ADrugDeclarationRepository
    {
        ...
        public void CloneDosageFinalDoc(Guid dosageId)
        {
            ...
            foreach (var expDrugDosage in list)
            {
                ...
                {
                    expFinal.AnalyticalConclusion = currentFinal.AnalyticalConclusion;
                    expFinal.AnalyticalConclusionKz = currentFinal.AnalyticalConclusionKz;
                    expFinal.Conclusion = currentFinal.Conclusion;
                    expFinal.ConclusionKz = currentFinal.ConclusionKz;
                    expFinal.IsAccepted = currentFinal.IsAccepted;
                    expFinal.IsAcceptedKz = currentFinal.IsAcceptedKz;
                    expFinal.PharmaceuticalConclusion = currentFinal.PharmaceuticalConclusion;
                    expFinal.PharmaceuticalConclusionKz = currentFinal.PharmaceuticalConclusionKz;
                    expFinal.PharmacologicalConclusion = currentFinal.PharmacologicalConclusion;
                    expFinal.PharmacologicalConclusionKz = currentFinal.PharmacologicalConclusionKz;
                    expFinal.PrimaryConclusion = currentFinal.PrimaryConclusion;
                    expFinal.PrimaryConclusionKz = currentFinal.PrimaryConclusionKz;
                    expFinal.Remark = currentFinal.Remark;
                    expFinal.RemarkKz = currentFinal.RemarkKz;
                }
            }
