    ...
    public class ContractRepository : ARepository
    {
        ...
        public void SaveContract(RequestModel model)
        {
            ...
            if (project)
            {
                ...
                if (model.Agent.Id != (agent = model.Manufacture).Id && model.Agent.Id != (agent = model.Applicant).Id)
                {
                    agent = model.Agent;
                    AppContext.Entry(agent).State = EntityState.Modified;
                }
                model.Contract.AgentOrganizationId = agent.Id;
                model.Contract.AgentOrganization = agent;

                var holder = model.Holder;
                if (model.Holder.Id != (holder = model.Manufacture).Id && model.Holder.Id != (holder = model.Applicant).Id && model.Holder.Id != (holder = model.Agent).Id)
                {
                    holder = model.Holder;
                ...
                if (model.Payer.Id != (payer = model.Manufacture).Id && model.Payer.Id != (payer = model.Applicant).Id &&
                    model.Payer.Id != (payer = model.Holder).Id && model.Payer.Id != (payer = model.Agent).Id)
                {
                ...
                if (model.PayerTranslation.Id != (payer = model.Manufacture).Id &&
                    ...
                    model.PayerTranslation.Id != (payer = model.Agent).Id)
                {
            ...
            else
            {
                ...
                {
                    agent = model.Agent;
                    if (AppContext.Organizations.Any(o => o.Id == agent.Id))
                    {
                        AppContext.Entry(agent).State = EntityState.Modified;
                    }
                    else
                    {
                        AppContext.Organizations.Add(agent);
                    }
                }
                model.Contract.AgentOrganizationId = agent.Id;
                model.Contract.AgentOrganization = agent;
        ...
        public Dictionary<string, string> GetContractTemplateData(Guid contractId)
        {
            ...
            result.Add("ContractDate",
                (data.Contract.ContractDate != null ? data.Contract.ContractDate.Value.ToString("dd.MM.yyyy") : "«__» ___________ 20___г."));
            ...
            if (data.ManufacturerOrganization != null)
            {
                ...
                result.Add("BossLastNameGenetive", GetGenitive(data.ManufacturerOrganization.BossLastName, TextTypes.Names, NounTypes.Undefined));
                result.Add("BossFirstName", data.ManufacturerOrganization.BossFirstName);
                result.Add("BossFirstNameGenetive", GetGenitive(data.ManufacturerOrganization.BossFirstName, TextTypes.Names, NounTypes.Undefined));
                result.Add("BossMiddleName", data.ManufacturerOrganization.BossMiddleName);
                result.Add("BossMiddleNameGenetive", GetGenitive(data.ManufacturerOrganization.BossMiddleName, TextTypes.Names, NounTypes.Undefined));
            ...
            if (data.HolderOrganization != null)
            {
                ...
                result.Add("HolderBossLastNameGenetive", GetGenitive(data.HolderOrganization.BossLastName, TextTypes.Names, NounTypes.Undefined));
                result.Add("HolderBossFirstName", data.HolderOrganization.BossFirstName);
                result.Add("HolderBossFirstNameGenetive", GetGenitive(data.HolderOrganization.BossFirstName, TextTypes.Names, NounTypes.Undefined));
                result.Add("HolderBossMiddleName", data.HolderOrganization.BossMiddleName);
                result.Add("HolderBossMiddleNameGenetive", GetGenitive(data.HolderOrganization.BossMiddleName, TextTypes.Names, NounTypes.Undefined));
            ...
            result.Add("SignerPositionGenetive", data.Signer != null ? GetGenitive(data.Signer.Position.Name) : null);
            result.Add("SignerInitials", data.Signer != null ? data.Signer.ShortName : null);
            result.Add("SignerInitialsGenetive", data.Signer != null ? GetGenitive(data.Signer.ShortName, TextTypes.Names, (NounTypes)data.Signer.Sex) : null);
            result.Add("DoverennostType", data.DoverennostType != null ? data.DoverennostType.Name : null);
            result.Add("DoverennostTypeGenetive", data.DoverennostType != null ? GetGenitive(data.DoverennostType.Name) : null);
            ...
            if (data.ApplicantOrganization != null)
            {
                ...
                result.Add("ApplicantLastNameGenetive", GetGenitive(data.ApplicantOrganization.BossLastName, TextTypes.Names, NounTypes.Undefined));
                result.Add("ApplicantFirstName", data.ApplicantOrganization.BossFirstName);
                result.Add("ApplicantFirstNameGenetive", GetGenitive(data.ApplicantOrganization.BossFirstName, TextTypes.Names, NounTypes.Undefined));
                result.Add("ApplicantMiddleName", data.ApplicantOrganization.BossMiddleName);
                result.Add("ApplicantMiddleNameGenetive", GetGenitive(data.ApplicantOrganization.BossMiddleName, TextTypes.Names, NounTypes.Undefined));
        ...
        //Получение родительского падежа текста
        private string GetGenitive(string text, TextTypes sentenceType = TextTypes.Undefined, NounTypes nounType = NounTypes.Undefined)
        {
            if (string.IsNullOrEmpty(text)) return "";
            Dictionary<string, string> exceptions = new Dictionary<string, string>();
            exceptions.Add("Доверенность от производителя", "Доверенности от производителя");
            exceptions.Add("Довернность от держателя регистрационного удостоверения", "Довернности от держателя регистрационного удостоверения");
            if (exceptions.ContainsKey(text)) return exceptions[text];
            var words = text.Split(' ');
            string res = string.Empty;
            foreach (var word in words)
            {
                string newWord = word;
                if (sentenceType == TextTypes.Names)
                {
                    if (!word.Contains(".") && word.Length > 3)
                    {
                        if (nounType == NounTypes.Masculine)
                        {
                            var ending = word.Substring(word.Length - 3);
                            if (ending == "ний" || ending == "ший" || ending == "щий")
                            {
                                newWord = word.Substring(0, word.Length - 2) + "его";
                            }
                            else
                            {
                                ...
                                {
                                    case "й":
                                        newWord = word.Substring(0, word.Length - 1) + "я"; break;
                                    case "я":
                                        newWord = word.Substring(0, word.Length - 1) + "и"; break;
                                    case "о":
                                        break;
                                    default:
                                        newWord = word + "а"; break;
                                }
                            }
                        }
                        else if (nounType == NounTypes.Feminine)
                        {
                            var ending = word.Substring(word.Length - 2);
                            if (ending == "ва")
                            {
                                newWord = word.Substring(0, word.Length - 1) + "ой";
                            }
                            else
                            {
                                ending = word.Substring(word.Length - 1);
                                ...
                                {
                                    case "а":
                                        newWord = word.Substring(0, word.Length - 1) + "ы"; break;
                                    case "я":
                                        newWord = word.Substring(0, word.Length - 1) + "и"; break;
                                    default:
                                        break;
                        ...
                        else if (nounType == NounTypes.Undefined)
                        {
                            var ending = word.Substring(word.Length - 3);
                            if (ending == "ний" || ending == "ший" || ending == "щий")
                            {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case "а":
                                            newWord = word.Substring(0, word.Length - 1) + "ы";
                                            break;
                                        case "я":
                                            newWord = word.Substring(0, word.Length - 1) + "и";
                                            break;
                                        case "й":
                                            newWord = word.Substring(0, word.Length - 1) + "я";
                                            break;
                                        case "о":
                                            newWord = word;
                                            break;
                ...
                else
                {
                    if (!word.Contains(".") && word.Length > 3)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                case "ый":
                                    newWord = word.Substring(0, word.Length - 2) + "ого";
                                    isChanged = true;
                                    break;
                                case "ий":
                                    newWord = word.Substring(0, word.Length - 2) + "ии";
                                    isChanged = true;
                                    break;
                                case "га":
                                    newWord = word.Substring(0, word.Length - 2) + "ги";
                                    isChanged = true;
                                    break;
                                case "ка":
                                    newWord = word.Substring(0, word.Length - 2) + "ки";
                                    isChanged = true;
                                    break;
                                case "ец":
                                    newWord = word.Substring(0, word.Length - 2) + "ца";
                                    isChanged = true;
                                    break;
                                case "ие":
                                    newWord = word.Substring(0, word.Length - 2) + "ия";
                                    isChanged = true;
                                    break;
                                case "ия":
                                    newWord = word.Substring(0, word.Length - 2) + "ии";
                                    ...
                                    break;
                                case "ль":
                                    newWord = word.Substring(0, word.Length - 2) + "ля";
                                    isChanged = true;
                                    break;
                                case "ть":
                                    newWord = word.Substring(0, word.Length - 2) + "ти";
                                    isChanged = true;
                                    break;
                                default:
                                    break;
                            ...
                            if (!isChanged)
                            {
                                ...
                                switch (ending)
                                {
                                    ...
                                    case "ь":
                                        ...
                                        break;
                                    case "о":
                                        newWord = word.Substring(0, word.Length - 1) + "а";
                                        break;
                                    default:
                                        newWord = word + "а";
                                        break;
        ...
        public DataModel.Contract SetNumberAndDate(Guid contractId, string contractNumber, DateTime contractDate)
        {
            var contract = AppContext.Contracts.FirstOrDefault(e => e.Id == contractId);
        ...
        public void RegisterContract(Guid contractId)
        {
                ...
                && origPayerTranslationId != origApplicantId)
            {
                ...
                contract.PayerTranslationOrganization = histPayerTranslation;
            }
            if (origPayerTranslationId == origProducerId)
            {
        ...
        public List<ContractAgreementHistory> GetContractAgreementHistory(Guid contractId)
        {
            return AppContext.EXP_Tasks.Where(e => e.EXP_Activities.DocumentId == contractId && e.ExpTaskType.Code == Dictionary.ExpTaskType.Agreement)
                .OrderBy(e=>e.ExecutedDate)
                .Select(e => new ContractAgreementHistory()
                {
                    StatusCode = e.StatusesDictionary.Code,
                    OperationDate = e.ExecutedDate,
                    Comment = e.Comment
                }).ToList();
        }
        ...
        {
            var contract = AppContext.Contracts.Find(contractId);
            AppContext.Contracts.Remove(contract);
            AppContext.SaveChanges();
        }
    }
}